...
void _EV_tp_free_timeout_cb(EV_t *listener, EV_timer_t *timer){
  EV_timer_stop(listener, timer);

  _EV_tp_internal_pool_free_t *pool_free = OFFSETLESS(timer, _EV_tp_internal_pool_free_t, evt);
