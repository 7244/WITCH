A_resize_t NET_TCP_read_GetResize_SpecialPointer(
  NET_TCP_t *tcp,
  NET_TCP_peer_t *peer,
  ...
  return ((NET_TCP_layer_read_t *)tcp->op[NET_TCP_opid_read_e].layer)[layerid].resize_SpecialPointer;
}
A_resize_t NET_TCP_read_GetNextResize_SpecialPointer(
  NET_TCP_t *tcp,
  NET_TCP_peer_t *peer,
  NET_TCP_QueuerReference_t QueuerReference
){
...
A_resize_t NET_TCP_read_GetResize_SignedSpecialPointer(
  NET_TCP_t *tcp,
  NET_TCP_peer_t *peer,
  NET_TCP_QueuerReference_t QueuerReference
){
  ...
  NET_TCP_Queuer_t *Queuer = &QueuerNode->data.data;
  NET_TCP_layerid_t layerid = Queuer->layerid;
  return ((NET_TCP_layer_read_t *)tcp->op[NET_TCP_opid_read_e].layer)[layerid].resize_SignedSpecialPointer;
}
A_resize_t NET_TCP_read_GetNextResize_SignedSpecialPointer(
  NET_TCP_t *tcp,
  NET_TCP_peer_t *peer,
  NET_TCP_QueuerReference_t QueuerReference
){
...
bool NET_TCP_EXT_read_is_active(NET_TCP_peer_t *peer, NET_TCP_QueuerReference_t QueuerReference){
  _NET_TCP_QueuerList_Node_t *QueuerNode = _NET_TCP_QueuerList_GetNodeByReference(
    &peer->ReadQueuerList,
    QueuerReference);
  NET_TCP_Queuer_t *Queuer = &QueuerNode->data.data;
...
bool NET_TCP_EXT_read_is_active2(NET_TCP_peer_t *peer, NET_TCP_Queuer_t *Queuer){
  return Queuer->QueueFirstNode != -1;
}

bool NET_TCP_EXT_read_get(
  NET_TCP_peer_t *peer,
  NET_TCP_QueuerReference_t QueuerReference,
...
void NET_TCP_EXT_read_get2(NET_TCP_peer_t *peer, NET_TCP_Queuer_t *Queuer, NET_TCP_QueueElement_t **QueueElement){
  *QueueElement = (NET_TCP_QueueElement_t *)VAS_out(&peer->queue, Queuer->QueueFirstNode);
}

bool NET_TCP_EXT_read_del(NET_TCP_peer_t *peer, NET_TCP_QueuerReference_t QueuerReference){
  if(peer->TimerNode != -1){
    NET_TCP_UpdatePeerTimer(peer->parent->listener, peer->parent, peer);
  }
  _NET_TCP_QueuerList_Node_t *QueuerNode = _NET_TCP_QueuerList_GetNodeByReference(
...
void NET_TCP_EXT_read_del2(NET_TCP_peer_t *peer, NET_TCP_Queuer_t *Queuer){
  if(peer->TimerNode != -1){
    NET_TCP_UpdatePeerTimer(peer->parent->listener, peer->parent, peer);
  }
  VAS_node_t next = *VAS_road0(&peer->queue, Queuer->QueueFirstNode);
...
NET_TCP_layerflag_t NET_TCP_read_loop(
  ...
  NET_TCP_op_t *opread = &peer->parent->op[NET_TCP_opid_read_e];
  while(1){
    _NET_TCP_QueuerList_Node_t *QueuerNode = _NET_TCP_QueuerList_GetNodeByReference(
      &peer->ReadQueuerList,
      QueuerReference);
    NET_TCP_Queuer_t *Queuer = &QueuerNode->data.data;
    NET_TCP_layer_read_t *layer = &((NET_TCP_layer_read_t *)opread->layer)[Queuer->layerid];
    NET_TCP_extinfo_t *extinfo = &peer->parent->ext.info[layer->extid];
    NET_TCP_layerflag_t layerflag = ((NET_TCP_cb_read_t)layer->func)(
      peer,
